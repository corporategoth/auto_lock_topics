...
*/
class auto_lock_forum extends \phpbb\cron\task\base implements \phpbb\cron\task\parametrized
{
	...
	* about a single forum that is to be auto_lockd.
	*
	...
	*
	* @param array $forum_data Information about a forum to be auto_lockd.
	*/
	...
	* such cases auto_lock_all_forums task would run instead.
	*
	...
	*/
	...
	{
		return $this->forum_data['enable_auto_lock'] && $this->forum_data['auto_lock_next'] < time();
	}

	/**
	* Returns parameters of this cron task as an array.
	* The array has one key, f, whose value is id of the forum to be auto_lockd.
	*
	* @return array
	*/
	...
	*
	* It is expected to have a key f whose value is id of the forum to be auto_lockd.
	*
